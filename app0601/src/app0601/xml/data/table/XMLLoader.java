...
public class XMLLoader {
	...
	public String load(String keyword) throws IOException{
		String key = "4xXxHRYsYf%2FFRFEHjZgHZNxyDDHX%2FylFHezwYoEz4fnOqXrIFpmJiO8lt4ysiM3eDJ5cyPO6FMxe4ih0WoslNg%3D%3D";
		
		//GET방식의 요천 주소 구성(파라미터 포함)
        ...
        return sb.toString(); //생성된 태그를 반환하자
	}
